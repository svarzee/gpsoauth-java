...
final class EngineWriter {
     ...
     * other writeRecord.
     */
    synchronized void writeRecord(xxx.sun.security.ssl.EngineOutputRecord outputRecord,
                                  xxx.sun.security.ssl.Authenticator authenticator,
                                  xxx.sun.security.ssl.CipherBox writeCipher) throws IOException {
     ...
     */
    private void dumpPacket(xxx.sun.security.ssl.EngineArgs ea, boolean hsData) {
        try {
    ...
    synchronized HandshakeStatus writeRecord(
            xxx.sun.security.ssl.EngineOutputRecord outputRecord, xxx.sun.security.ssl.EngineArgs ea,
            xxx.sun.security.ssl.Authenticator authenticator,
            xxx.sun.security.ssl.CipherBox writeCipher) throws IOException {
