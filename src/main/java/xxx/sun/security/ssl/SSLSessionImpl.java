...
import static xxx.sun.security.ssl.CipherSuite.KeyExchange.K_KRB5;
import static xxx.sun.security.ssl.CipherSuite.KeyExchange.K_KRB5_EXPORT;
...
final class SSLSessionImpl extends ExtendedSSLSession {
     ...
     */
    static final xxx.sun.security.ssl.SSLSessionImpl nullSession = new xxx.sun.security.ssl.SSLSessionImpl();
    ...
    private final xxx.sun.security.ssl.SessionId sessionId;
    ...
    private xxx.sun.security.ssl.SSLSessionContextImpl context;
    ...
    private SSLSessionImpl() {
        this(ProtocolVersion.NONE, CipherSuite.C_NULL, null,
            new xxx.sun.security.ssl.SessionId(false, null), null, -1, false, null);
    }
    ...
    SSLSessionImpl(ProtocolVersion protocolVersion, CipherSuite cipherSuite,
        ...
        this(protocolVersion, cipherSuite, algorithms,
             new xxx.sun.security.ssl.SessionId(defaultRejoinable, generator), host, port,
    ...
    SSLSessionImpl(ProtocolVersion protocolVersion, CipherSuite cipherSuite,
                   Collection<xxx.sun.security.ssl.SignatureAndHashAlgorithm> algorithms,
                   xxx.sun.security.ssl.SessionId id, String host, int port,
        ...
        localSupportedSignAlgs =
            xxx.sun.security.ssl.SignatureAndHashAlgorithm.getAlgorithmNames(algorithms);
    ...
    xxx.sun.security.ssl.SessionId getSessionId() {
        return sessionId;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof xxx.sun.security.ssl.SSLSessionImpl) {
            xxx.sun.security.ssl.SSLSessionImpl sess = (xxx.sun.security.ssl.SSLSessionImpl) obj;
    ...
    void setContext(xxx.sun.security.ssl.SSLSessionContextImpl ctx) {
        if (context == null) {
            context = ctx;
        }
    }
     ...
     */
    private Hashtable<xxx.sun.security.ssl.SecureKey, Object> table = new Hashtable<>();
    ...
    public void putValue(String key, Object value) {
        ...
        xxx.sun.security.ssl.SecureKey secureKey = new xxx.sun.security.ssl.SecureKey(key);
    ...
    public String[] getValueNames() {
        Enumeration<xxx.sun.security.ssl.SecureKey> e;
        Vector<Object> v = new Vector<>();
        xxx.sun.security.ssl.SecureKey key;
        Object securityCtx = xxx.sun.security.ssl.SecureKey.getCurrentSecurityContext();
    ...
    public synchronized int getPacketBufferSize() {
        return acceptLargeFragments ?
                xxx.sun.security.ssl.Record.maxLargeRecordSize : xxx.sun.security.ssl.Record.maxRecordSize;
    }
    ...
    public synchronized int getApplicationBufferSize() {
        return getPacketBufferSize() - xxx.sun.security.ssl.Record.headerSize;
    }
...
class SecureKey {
    ...
    public boolean equals(Object o) {
        return o instanceof xxx.sun.security.ssl.SecureKey && ((xxx.sun.security.ssl.SecureKey)o).appKey.equals(appKey)
                        && ((xxx.sun.security.ssl.SecureKey)o).securityCtx.equals(securityCtx);
    }
}
