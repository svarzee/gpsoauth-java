...
import static xxx.sun.security.ssl.CipherSuite.KeyExchange.*;
import static xxx.sun.security.ssl.HandshakeMessage.*;
import static xxx.sun.security.ssl.HandshakeStateManager.HandshakeState.*;
...
final class HandshakeStateManager {
    ...
    static {
        debugIsOn = (xxx.sun.security.ssl.Handshaker.debug != null) &&
    ...
    void update(HandshakeMessage handshakeMessage,
        ...
        case HandshakeMessage.ht_server_hello:
            ...
            xxx.sun.security.ssl.HelloExtensions hes = serverHello.extensions;
