 ...
 */
final public class SSLSocketImpl extends xxx.sun.security.ssl.BaseSSLSocketImpl {
    ...
    private xxx.sun.security.ssl.CipherSuiteList enabledCipherSuites;
    ...
    private xxx.sun.security.ssl.InputRecord inrec;

    /*
     * Crypto state that's reinitialized when the session changes.
     */
    private xxx.sun.security.ssl.Authenticator readAuthenticator, writeAuthenticator;
     ...
     */
    private xxx.sun.security.ssl.Handshaker handshaker;
     ...
     */
    private xxx.sun.security.ssl.AppInputStream input;
    private xxx.sun.security.ssl.AppOutputStream output;
     ...
     */
    private xxx.sun.security.ssl.ProtocolList enabledProtocols;
    ...
    SSLSocketImpl(SSLContextImpl context, boolean serverMode,
                  xxx.sun.security.ssl.CipherSuiteList suites, byte clientAuth,
                  boolean sessionCreation, xxx.sun.security.ssl.ProtocolList protocols,
    ...
    private void init(SSLContextImpl context, boolean isServer) {
        ...
        input = new xxx.sun.security.ssl.AppInputStream(this);
        output = new xxx.sun.security.ssl.AppOutputStream(this);
    }
    ...
    void writeRecord(OutputRecord r, boolean holdRecord) throws IOException {
         ...
         */
    loop:
        while (r.contentType() == xxx.sun.security.ssl.Record.ct_application_data) {
            /*
    ...
    private void writeRecordInternal(OutputRecord r,
        ...
        if (isFirstAppOutputRecord &&
                r.contentType() == xxx.sun.security.ssl.Record.ct_application_data) {
    ...
    boolean needToSplitPayload() {
        ...
        try {
            return (protocolVersion.v <= ProtocolVersion.TLS10.v) &&
                    ...
                    xxx.sun.security.ssl.Record.enableCBCProtection;
        } finally {
            writeLock.unlock();
        }
    }
     ...
     */
    void readDataRecord(xxx.sun.security.ssl.InputRecord r) throws IOException {
     ...
     */
    private void readRecord(xxx.sun.security.ssl.InputRecord r, boolean needAppData)
            throws IOException {
        int state;
      ...
      synchronized (readLock) {
        ...
        while (((state = getConnectionState()) != cs_CLOSED) &&
            ...
            try {
                ...
                byte alertType = (r.contentType() == xxx.sun.security.ssl.Record.ct_handshake)
            ...
            synchronized (this) {
              switch (r.contentType()) {
                case xxx.sun.security.ssl.Record.ct_handshake:
                    /*
                ...
                case xxx.sun.security.ssl.Record.ct_application_data:
                ...
                case xxx.sun.security.ssl.Record.ct_alert:
                    recvAlert(r);
                    continue;

                case xxx.sun.security.ssl.Record.ct_change_cipher_spec:
     ...
     * renegotiate instead."
     */
    private void checkSequenceNumber(xxx.sun.security.ssl.Authenticator authenticator, byte type)
            throws IOException {
         ...
         * asking for it.
         */
        if ((type != xxx.sun.security.ssl.Record.ct_handshake) && authenticator.seqNumIsHuge()) {
            if (debug != null && Debug.isOn("ssl")) {
                System.out.println(Thread.currentThread().getName() +
     ...
     */
    xxx.sun.security.ssl.AppInputStream getAppInputStream() {
        return input;
    }
     ...
     */
    xxx.sun.security.ssl.AppOutputStream getAppOutputStream() {
        return output;
    }
    ...
    private void performInitialHandshake() throws IOException {
        ...
        synchronized (handshakeLock) {
            if (getConnectionState() == cs_HANDSHAKE) {
                 ...
                 */
                if (inrec == null) {
                    inrec = new xxx.sun.security.ssl.InputRecord();
    ...
    private synchronized void kickstartHandshake() throws IOException {
        ...
        case cs_DATA:
            if (!secureRenegotiation && !xxx.sun.security.ssl.Handshaker.allowUnsafeRenegotiation) {
     ...
     * access to "this".
     */
    private void recvAlert(xxx.sun.security.ssl.InputRecord r) throws IOException {
    ...
    private void sendAlert(byte level, byte description) {
        ...
        OutputRecord r = new OutputRecord(xxx.sun.security.ssl.Record.ct_alert);
    ...
    synchronized public void setEnabledCipherSuites(String[] suites) {
        enabledCipherSuites = new xxx.sun.security.ssl.CipherSuiteList(suites);
        if ((handshaker != null) && !handshaker.activated()) {
            handshaker.setEnabledCipherSuites(enabledCipherSuites);
        }
    }
    ...
    synchronized public void setEnabledProtocols(String[] protocols) {
        enabledProtocols = new xxx.sun.security.ssl.ProtocolList(protocols);
        if ((handshaker != null) && !handshaker.activated()) {
