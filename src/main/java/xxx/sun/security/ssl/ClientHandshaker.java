 ...
 */
final class ClientHandshaker extends xxx.sun.security.ssl.Handshaker {
    ...
    ClientHandshaker(SSLSocketImpl socket, SSLContextImpl context,
                     xxx.sun.security.ssl.ProtocolList enabledProtocols,
    ...
    void processMessage(byte type, int messageLen) throws IOException {
        ...
        case HandshakeMessage.ht_server_key_exchange:
            ...
            case K_RSA_EXPORT:
                ...
                if (xxx.sun.security.ssl.JsseJce.getRSAKeyLength(serverKey) <= 512) {
                    throw new SSLProtocolException("Protocol violation:" +
        ...
        case HandshakeMessage.ht_certificate_request:
            ...
            if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                ...
                Collection<xxx.sun.security.ssl.SignatureAndHashAlgorithm> supportedPeerSignAlgs =
    ...
    private void serverHello(ServerHello mesg) throws IOException {
        ...
        xxx.sun.security.ssl.RenegotiationInfoExtension serverHelloRI = (xxx.sun.security.ssl.RenegotiationInfoExtension)
        ...
        xxx.sun.security.ssl.ExtendedMasterSecretExtension extendedMasterSecretExt =
        ...
        // check extensions
        for (xxx.sun.security.ssl.HelloExtension ext : mesg.extensions.list()) {
            xxx.sun.security.ssl.ExtensionType type = ext.type;
            if (type == xxx.sun.security.ssl.ExtensionType.EXT_SERVER_NAME) {
                serverNamesAccepted = true;
            } else if ((type != xxx.sun.security.ssl.ExtensionType.EXT_ELLIPTIC_CURVES)
                    && (type != xxx.sun.security.ssl.ExtensionType.EXT_EC_POINT_FORMATS)
                    && (type != xxx.sun.security.ssl.ExtensionType.EXT_SERVER_NAME)
                    && (type != xxx.sun.security.ssl.ExtensionType.EXT_RENEGOTIATION_INFO)
                    && (type != xxx.sun.security.ssl.ExtensionType.EXT_EXTENDED_MASTER_SECRET)){
                fatalSE(Alerts.alert_unsupported_extension,
        ...
        session = new xxx.sun.security.ssl.SSLSessionImpl(protocolVersion, cipherSuite,
    ...
    private void serverKeyExchange(DH_ServerKeyExchange mesg)
        ...
        dh = new xxx.sun.security.ssl.DHCrypt(mesg.getModulus(), mesg.getBase(),
    ...
    private void serverHelloDone(ServerHelloDone mesg) throws IOException {
            ...
            for (int i = 0; i < certRequest.types.length; i++) {
                ...
                switch (certRequest.types[i]) {
                    ...
                    case CertificateRequest.cct_ecdsa_sign:
                        ...
                        typeName = xxx.sun.security.ssl.JsseJce.isEcAvailable() ? "EC" : null;
                        break;
        ...
        case K_RSA_EXPORT:
            ...
            m2 = new xxx.sun.security.ssl.RSAClientKeyExchange(protocolVersion, maxProtocolVersion,
        ...
        case K_DH_DSS:
            ...
            m2 = new xxx.sun.security.ssl.DHClientKeyExchange();
            break;
        case K_DHE_RSA:
        case K_DHE_DSS:
        case K_DH_ANON:
            ...
            m2 = new xxx.sun.security.ssl.DHClientKeyExchange(dh.getPublicKey());
            break;
        case K_ECDHE_RSA:
        case K_ECDHE_ECDSA:
        case K_ECDH_ANON:
            ...
            m2 = new xxx.sun.security.ssl.ECDHClientKeyExchange(ecdh.getPublicKey());
            break;
        case K_ECDH_RSA:
        case K_ECDH_ECDSA:
            if (serverKey == null) {
        ...
        case K_RSA:
        case K_RSA_EXPORT:
            preMasterSecret = ((xxx.sun.security.ssl.RSAClientKeyExchange)m2).preMaster;
            break;
        case K_KRB5:
        case K_KRB5_EXPORT:
            byte[] secretBytes =
        ...
        if (signingKey != null) {
            ...
            try {
                xxx.sun.security.ssl.SignatureAndHashAlgorithm preferableSignatureAlgorithm = null;
                if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                    ...
                    String hashAlg =
                        xxx.sun.security.ssl.SignatureAndHashAlgorithm.getHashAlgorithmName(
                                preferableSignatureAlgorithm);
    ...
    private void serverFinished(Finished mesg) throws IOException {
        ...
        if (!resumingSession) {
            if (session.isRejoinable()) {
                ((xxx.sun.security.ssl.SSLSessionContextImpl) sslContext
    ...
    HandshakeMessage getKickstartMessage() throws SSLException {
        ...
        xxx.sun.security.ssl.SessionId sessionId = xxx.sun.security.ssl.SSLSessionImpl.nullSession.getSessionId();

        // a list of cipher suites sent by the client
        xxx.sun.security.ssl.CipherSuiteList cipherSuites = getActiveCipherSuites();
        ...
        //
        session = ((xxx.sun.security.ssl.SSLSessionContextImpl)sslContext
                        .engineGetClientSessionContext())
        ...
        if (session != null) {
            ...
            if (!enableNewSession) {
                ...
                cipherSuites = new xxx.sun.security.ssl.CipherSuiteList(cipherList);
            }
        }
        ...
        if (cipherSuites.containsEC()) {
            xxx.sun.security.ssl.EllipticCurvesExtension ece =
                xxx.sun.security.ssl.EllipticCurvesExtension.createExtension(algorithmConstraints);
            if (ece != null) {
                clientHelloMessage.extensions.add(ece);
                clientHelloMessage.extensions.add(
                   xxx.sun.security.ssl.EllipticPointFormatsExtension.DEFAULT);
            }
        }
        ...
        if (maxProtocolVersion.v >= ProtocolVersion.TLS12.v) {
            ...
            Collection<xxx.sun.security.ssl.SignatureAndHashAlgorithm> localSignAlgs =
                                                getLocalSupportedSignAlgs();
