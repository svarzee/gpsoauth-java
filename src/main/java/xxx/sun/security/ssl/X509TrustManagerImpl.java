...
import xxx.sun.security.validator.KeyStores;
import xxx.sun.security.validator.Validator;
...
final class X509TrustManagerImpl extends X509ExtendedTrustManager
        ...
        if ((socket != null) && socket.isConnected() &&
            ...
            if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                if (session instanceof ExtendedSSLSession) {
                    ...
                    constraints = new xxx.sun.security.ssl.SSLAlgorithmConstraints(
                                    sslSocket, localSupportedSignAlgs, false);
                } else {
                    constraints =
                            new xxx.sun.security.ssl.SSLAlgorithmConstraints(sslSocket, false);
                }
            } else {
                constraints = new xxx.sun.security.ssl.SSLAlgorithmConstraints(sslSocket, false);
            }
        }
        ...
        if (engine != null) {
            ...
            if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                if (session instanceof ExtendedSSLSession) {
                    ...
                    constraints =
                            new xxx.sun.security.ssl.SSLAlgorithmConstraints(engine, false);
                }
            } else {
                constraints = new xxx.sun.security.ssl.SSLAlgorithmConstraints(engine, false);
            }
        }
    ...
    private static X509Certificate[] validate(Validator v,
        ...
        Object o = xxx.sun.security.ssl.JsseJce.beginFipsProvider();
        try {
            return v.validate(chain, null, constraints, authType);
        } finally {
            xxx.sun.security.ssl.JsseJce.endFipsProvider(o);
        }
    }
