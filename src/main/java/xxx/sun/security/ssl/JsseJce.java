...
import static xxx.sun.security.ssl.SunJSSE.cryptoProvider;
...
final class JsseJce {
    ...
    static RSAPublicKeySpec getRSAPublicKeySpec(PublicKey key) {
        ...
        try {
            KeyFactory factory = xxx.sun.security.ssl.JsseJce.getKeyFactory("RSA");
    ...
    private static class EcAvailability {
        ...
        static {
            ...
            try {
                xxx.sun.security.ssl.JsseJce.getSignature(SIGNATURE_ECDSA);
                xxx.sun.security.ssl.JsseJce.getSignature(SIGNATURE_RAWECDSA);
                xxx.sun.security.ssl.JsseJce.getKeyAgreement("ECDH");
                xxx.sun.security.ssl.JsseJce.getKeyFactory("EC");
                xxx.sun.security.ssl.JsseJce.getKeyPairGenerator("EC");
                xxx.sun.security.ssl.JsseJce.getAlgorithmParameters("EC");
            } catch (Exception e) {
                mediator = false;
            }
