 ...
 */
class OutputRecord extends ByteArrayOutputStream implements xxx.sun.security.ssl.Record {
    ...
    void encrypt(Authenticator authenticator, CipherBox box)
        ...
        // cipher suites.
        if (authenticator instanceof xxx.sun.security.ssl.MAC) {
            xxx.sun.security.ssl.MAC signer = (xxx.sun.security.ssl.MAC)authenticator;
            if (signer.MAClen() != 0) {
        ...
        if (debug != null
            ...
            if ((debug != null && Debug.isOn("record"))
                ...
                System.out.println(Thread.currentThread().getName()
                    ...
                    + " " + xxx.sun.security.ssl.InputRecord.contentName(contentType())
                    + ", length = " + length);
        }
