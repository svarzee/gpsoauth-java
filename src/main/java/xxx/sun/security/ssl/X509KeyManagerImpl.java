...
final class X509KeyManagerImpl extends X509ExtendedKeyManager
        ...
        if (socket != null && socket.isConnected() &&
            ...
            if (session != null) {
                ...
                if (protocolVersion.v >= ProtocolVersion.TLS12.v) {
                    ...
                    return new xxx.sun.security.ssl.SSLAlgorithmConstraints(
                        sslSocket, peerSupportedSignAlgs, true);
                }
            }

            return new xxx.sun.security.ssl.SSLAlgorithmConstraints(sslSocket, true);
        }

        return new xxx.sun.security.ssl.SSLAlgorithmConstraints((SSLSocket)null, true);
    }
    ...
    private AlgorithmConstraints getAlgorithmConstraints(SSLEngine engine) {
        ...
        return new xxx.sun.security.ssl.SSLAlgorithmConstraints(engine, true);
    }
    ...
    private static enum CheckType {
        ...
        // note: we may want to move this code into the xxx.sun.security.validator
        // package
