...
final class EllipticPointFormatsExtension extends xxx.sun.security.ssl.HelloExtension {
    ...
    static final xxx.sun.security.ssl.HelloExtension DEFAULT =
        new xxx.sun.security.ssl.EllipticPointFormatsExtension(
