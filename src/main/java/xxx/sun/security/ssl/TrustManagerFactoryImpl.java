...
abstract class TrustManagerFactoryImpl extends TrustManagerFactorySpi {
    ...
    public static final class SimpleFactory extends xxx.sun.security.ssl.TrustManagerFactoryImpl {
        @Override
    ...
    public static final class PKIXFactory extends xxx.sun.security.ssl.TrustManagerFactoryImpl {
        @Override
        X509TrustManager getInstance(KeyStore ks) throws KeyStoreException {
