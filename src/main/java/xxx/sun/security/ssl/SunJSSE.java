...
public abstract class SunJSSE extends Provider {
    ...
    private SunJSSE(Provider cryptoProvider,
                    String providerName) {
    ...
    private void doRegister(boolean isfips) {
        ...
        put("Signature.MD5andSHA1withRSA",
                "xxx.sun.security.ssl.RSASignature");

        put("KeyManagerFactory.SunX509",
                "xxx.sun.security.ssl.KeyManagerFactoryImpl$SunX509");
        put("KeyManagerFactory.NewSunX509",
                "xxx.sun.security.ssl.KeyManagerFactoryImpl$X509");
        put("Alg.Alias.KeyManagerFactory.PKIX", "NewSunX509");

        put("TrustManagerFactory.SunX509",
                "xxx.sun.security.ssl.TrustManagerFactoryImpl$SimpleFactory");
        put("TrustManagerFactory.PKIX",
                "xxx.sun.security.ssl.TrustManagerFactoryImpl$PKIXFactory");
        put("Alg.Alias.TrustManagerFactory.SunPKIX", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X509", "PKIX");
        put("Alg.Alias.TrustManagerFactory.X.509", "PKIX");

        put("SSLContext.TLSv1",
                "xxx.sun.security.ssl.SSLContextImpl$TLS10Context");
        put("SSLContext.TLSv1.1",
                "xxx.sun.security.ssl.SSLContextImpl$TLS11Context");
        put("SSLContext.TLSv1.2",
                "xxx.sun.security.ssl.SSLContextImpl$TLS12Context");
        put("SSLContext.TLS",
                "xxx.sun.security.ssl.SSLContextImpl$TLSContext");
        if (isfips == false) {
        ...
        put("SSLContext.Default",
                "xxx.sun.security.ssl.SSLContextImpl$DefaultSSLContext");
    ...
    private void subclassCheck() {
        if (getClass() != (Class<?>) com.sun.net.ssl.internal.ssl.Provider.class) {
