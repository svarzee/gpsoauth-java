...
abstract class KeyManagerFactoryImpl extends KeyManagerFactorySpi {
    ...
    public static final class SunX509 extends xxx.sun.security.ssl.KeyManagerFactoryImpl {
        ...
        protected void engineInit(KeyStore ks, char[] password) throws
            ...
            keyManager = new xxx.sun.security.ssl.SunX509KeyManagerImpl(ks, password);
            isInitialized = true;
        }
    ...
    public static final class X509 extends xxx.sun.security.ssl.KeyManagerFactoryImpl {
        ...
        protected void engineInit(KeyStore ks, char[] password) throws
                ...
                UnrecoverableKeyException {
            if (ks == null) {
                keyManager = new xxx.sun.security.ssl.X509KeyManagerImpl(
                ...
                try {
                    ...
                    keyManager = new xxx.sun.security.ssl.X509KeyManagerImpl(builder);
        ...
        protected void engineInit(ManagerFactoryParameters params) throws
            ...
            keyManager = new xxx.sun.security.ssl.X509KeyManagerImpl(builders);
            isInitialized = true;
        }
