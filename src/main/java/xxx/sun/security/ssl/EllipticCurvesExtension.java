...
final class EllipticCurvesExtension extends xxx.sun.security.ssl.HelloExtension {
    ...
    static xxx.sun.security.ssl.EllipticCurvesExtension createExtension(
        ...
        if (!idList.isEmpty()) {
            ...
            return new xxx.sun.security.ssl.EllipticCurvesExtension(ids);
        }
