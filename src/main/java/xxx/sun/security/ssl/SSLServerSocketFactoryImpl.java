...
public class SSLServerSocketFactoryImpl extends SSLServerSocketFactory
{
    ...
    public ServerSocket createServerSocket() throws IOException {
        return new xxx.sun.security.ssl.SSLServerSocketImpl(context);
    }
    ...
    throws IOException
    {
        return new xxx.sun.security.ssl.SSLServerSocketImpl(port, DEFAULT_BACKLOG, context);
    }
    ...
    throws IOException
    {
        return new xxx.sun.security.ssl.SSLServerSocketImpl(port, backlog, context);
    }
    ...
    throws IOException
    {
        return new xxx.sun.security.ssl.SSLServerSocketImpl(port, backlog, ifAddress, context);
    }
