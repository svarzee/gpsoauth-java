...
class EndEntityChecker {
    ...
    static xxx.sun.security.validator.EndEntityChecker getInstance(String type, String variant) {
        return new xxx.sun.security.validator.EndEntityChecker(type, variant);
    }
    ...
    void check(X509Certificate[] chain, Object parameter,
        ...
        for (xxx.sun.security.validator.CADistrustPolicy policy : xxx.sun.security.validator.CADistrustPolicy.POLICIES) {
