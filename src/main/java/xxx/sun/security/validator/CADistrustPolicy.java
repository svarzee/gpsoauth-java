 ...
 * questions.
 */
package xxx.sun.security.validator;
...
enum CADistrustPolicy {
    ...
    SYMANTEC_TLS {
        void checkDistrust(String variant, X509Certificate[] chain)
            ...
            xxx.sun.security.validator.SymantecTLSPolicy.checkDistrust(chain);
        }
    };
    ...
    static final EnumSet<xxx.sun.security.validator.CADistrustPolicy> POLICIES = parseProperty();
    private static EnumSet<xxx.sun.security.validator.CADistrustPolicy> parseProperty() {
        ...
        EnumSet<xxx.sun.security.validator.CADistrustPolicy> set = EnumSet.noneOf(xxx.sun.security.validator.CADistrustPolicy.class);
        ...
        for (String policy : policies) {
            policy = policy.trim();
            try {
                xxx.sun.security.validator.CADistrustPolicy caPolicy =
                    Enum.valueOf(xxx.sun.security.validator.CADistrustPolicy.class, policy);
                set.add(caPolicy);
